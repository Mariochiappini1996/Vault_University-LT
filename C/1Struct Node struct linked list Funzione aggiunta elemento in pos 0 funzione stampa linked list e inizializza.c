...
linked_list in0(linked_list L, float e){//Aggiunta elemento in pos 0
...
void print_llist(linked_list L){ //Funzione stampa linked list
	node *p = L.a;
...
linked_list init(void) { //Funzione Inizializza
