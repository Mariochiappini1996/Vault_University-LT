...
public class Allenatore extends Sportivo {
	...
	Allenatore(String Nome, String Cognome, Date Data_Assunzione, int Stipendio, int Numero_Iscrizione, int Numero_Reti, String TipologiaSportivo){
	...
	public boolean Tipologia_Sportivo(Sportivo sportivo) {
		...
		if (sportivo.TipologiaSportivo == "Allenatore") {
			return true;
		}
		else {
			return false;
